...
[source,java]
----
include::../src/main/java/com/example/demo/persistence/indexed/AerospikeIndexConfiguration.java[]
----
...
[source,java]
----
include::../src/main/java/com/example/demo/persistence/indexed/IndexedDocument.java[]
----
