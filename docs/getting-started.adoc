...
[source,java]
----
include::../src/main/java/com/example/demo/persistence/MovieDocument.java[]
----
...
[source,java]
----
include::../src/main/java/com/example/demo/persistence/MovieRepository.java[]
----
...
[source,java]
----
include::../src/main/java/com/example/demo/persistence/AerospikeConfiguration.java[]
----
