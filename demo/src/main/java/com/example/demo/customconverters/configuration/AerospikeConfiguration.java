package com.example.demo.customconverters.configuration;

import com.example.demo.customconverters.converter.ArticleDocumentConverters;
...
@Configuration
@EnableAerospikeRepositories(basePackages = "com.example.demo.customconverters.repository")
